...
export class OccupancyGridMap {
    ...
    updateWithLidarData(robotWorldX, robotWorldY, robotHeading, lidarDevice // ส่วนของ Lidar ที่จำเป็น
    ) {
        ...
        const lidarAngle = lidarDevice.lidarAngle;
        for (let angleOffset = 0; angleOffset < lidarAngle * Math.PI; angleOffset += lidarAngleStepRad) {
